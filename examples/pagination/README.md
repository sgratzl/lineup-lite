# LineUp-lite Example: Pagination
...
[Open this example in a new CodeSandbox](https://codesandbox.io/s/github/sgratzl/lineup-lite/tree/main/examples/virtualized-rows)
