# LineUp-lite Example: Controlled State
...
[Open this example in a new CodeSandbox](https://codesandbox.io/s/github/sgratzl/lineup-lite/tree/main/examples/controlled-state)
