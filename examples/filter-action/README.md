# LineUp-lite Example: Filter Action
...
[Open this example in a new CodeSandbox](https://codesandbox.io/s/github/sgratzl/lineup-lite/tree/main/examples/filter-action)
