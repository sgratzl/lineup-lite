# LineUp-lite Example: Flex Layout
...
[Open this example in a new CodeSandbox](https://codesandbox.io/s/github/sgratzl/lineup-lite/tree/main/examples/flex-layout)
