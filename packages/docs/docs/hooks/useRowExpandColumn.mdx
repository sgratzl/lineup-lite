...
The [`useRowExpandColumn`](/api/hooks/modules.html#userowexpandcolumn) react-table plugin hook injects a new column at the beginning for expanding and collapsing groups.
