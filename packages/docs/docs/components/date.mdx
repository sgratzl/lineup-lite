...
function Example() {
  ...
  const data = [new Date(2008, 11, 1), new Date(2008, 8, 1), new Date(2008, 4, 1), new Date(2009, 2, 1), new Date(2010, 9, 1), new Date(2010, 1, 1), new Date(2018, 1, 1)];
